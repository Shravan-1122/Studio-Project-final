...
<div class="container mt-5">
    ...
    <div class="mt-3">
       <center><h1>Web Series List</h1></center>
        <!-- "Add Web Series" Button -->
                        ...
                        <tr>
                            <td>
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="customSwitch{{ $post->id }}" data-post-id="{{ $post->id }}" {{ $post->status ? 'checked' : '' }}>
...
<script>
    $(document).ready(function() {
        ...
        // Function to get status from the server
        ...
        // Initialize button statuses by fetching them from the server
        $('.custom-control-input').each(function() {
            var postId = $(this).data('post-id');
            getStatus(postId);
        });

        // Listen for change event on switches
