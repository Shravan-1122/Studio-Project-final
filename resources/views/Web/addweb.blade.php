...
<body>
<center> <h1>Add web series Page</h1></center>
    <div class="container mt-5">
        <form method="post" id="add_create" name="add_create" action="{{ route('web.addweb') }}">
            @csrf
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block">Add web series</button>
            </div>
        </form>
    </div>
